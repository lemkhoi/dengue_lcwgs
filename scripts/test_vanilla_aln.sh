...
#SBATCH -J aln063
#SBATCH -p short
#SBATCH -o logs/test_aln063.out
#SBATCH -e logs/test_aln063.err
...
picard="java -Xmx40G -Xms20G -jar ${home_dir}conda/skylake/envs/aln17/share/picard-slim-2.27.4-0/picard.jar"
